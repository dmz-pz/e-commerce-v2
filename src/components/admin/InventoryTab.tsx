...
export const InventoryTab: React.FC<InventoryTabProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
        ...
        <div className="flex flex-row items-center gap-3 justify-end shrink-0">
          ...
          {onManageCategories && (
            <button
              ...
              className="flex items-center gap-2 bg-slate-800 text-white text-[11px] font-black uppercase tracking-widest px-5 h-11 rounded-xl hover:bg-slate-900 transition-all shadow-md shadow-slate-900/10 cursor-pointer shrink-0"
            >
          ...
          {onCreateProduct && (
            <button
              ...
              className="flex items-center gap-2 bg-brand text-white text-[11px] font-black uppercase tracking-widest px-6 h-11 rounded-xl hover:bg-brand-dark transition-all shadow-md shadow-brand/15 cursor-pointer shrink-0"
            >
            ...
            <div key={p.id} className="p-5 flex flex-col gap-3.5 hover:bg-slate-50/40 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-2.5 bg-slate-50 p-3 rounded-2xl border border-slate-100/70 text-xs text-slate-500">
                ...
                <div>
                  ...
                  <span className={`inline-block px-2 py-0.5 rounded-md text-[10px] font-mono font-bold ${p.stock <= 0 ? 'bg-rose-50 text-rose-600 border border-rose-100' :
                      p.stock < 15 ? 'bg-amber-50 text-amber-600 border border-amber-100' :
